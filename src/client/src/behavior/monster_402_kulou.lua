tree = {type=2,title='根',childs={
	{type=2,title='攻击或移动',childs={
		...
		{type=1,title='普攻1',childs={
			{type=7,title='目标500',func = 'target_in_range', args={max=500}},
			{type=7,title='attack',func = 'ai_state', args = {state = 'attack', cd = 8}}
			}},
		{type=1,title='普攻2',childs={
			{type=7,title='目标190',func = 'target_in_range', args={max=190}},
		...
		{type=1,title='有敌人',childs={
			...
			{type=7,title='移动目标190',func = 'move_to_target', args={distance_max = 190}}
			}}
		}},
