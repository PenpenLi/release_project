-- lua_class
-- local super_class = lua_class( 'super_class' )
-- local child_class = lua_class( 'child_class', super_class )
-- function super_class:_init()
--		print( 'super init' )
-- end
-- function child_class:_init()
--		super(child_class, self)._init()
-- end
